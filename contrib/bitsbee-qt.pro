...
RESOURCES += src/qt/bitsbee.qrc src/qt/bitsbee_locale.qrc

TRANSLATIONS += src/qt/locale/bitsbee_bg.ts \
                src/qt/locale/bitsbee_de.ts \
                src/qt/locale/bitsbee_en.ts \
                src/qt/locale/bitsbee_es.ts \
                src/qt/locale/bitsbee_fi.ts \
                src/qt/locale/bitsbee_fr.ts \
                src/qt/locale/bitsbee_it.ts \
                src/qt/locale/bitsbee_ja.ts \
                src/qt/locale/bitsbee_pl.ts \
                src/qt/locale/bitsbee_pt.ts \
                src/qt/locale/bitsbee_ru.ts \
                src/qt/locale/bitsbee_sk.ts \
                src/qt/locale/bitsbee_sv.ts \
                src/qt/locale/bitsbee_vi.ts \
                src/qt/locale/bitsbee_zh_CN.ts \
                src/qt/locale/bitsbee_zh_TW.ts
