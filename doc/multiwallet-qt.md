...
In order to support loading of multiple wallets in bitsbee-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitsbee.cpp.
...
Changes to bitsbee.cpp
----------------------
bitsbee.cpp is the entry point into bitsbee-qt, and as such, will require some minor modifications to provide hooks for
