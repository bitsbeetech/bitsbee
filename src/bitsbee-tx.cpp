...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bitsbee Core bitsbee-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitsbee-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitsbee transaction") + "\n" +
                               "  bitsbee-tx [options] -create [commands]   " + _("Create hex-encoded bitsbee transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitsbee transaction
