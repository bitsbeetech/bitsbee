...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Bitsbee server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bitsbee features */
        {"bitsbee", "masternode", &masternode, true, true, false},
        {"bitsbee", "listmasternodes", &listmasternodes, true, true, false},
        {"bitsbee", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitsbee", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitsbee", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitsbee", "masternodedebug", &masternodedebug, true, true, false},
        {"bitsbee", "startmasternode", &startmasternode, true, true, false},
        {"bitsbee", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitsbee", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitsbee", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitsbee", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitsbee", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitsbee", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitsbee", "mnbudget", &mnbudget, true, true, false},
        {"bitsbee", "preparebudget", &preparebudget, true, true, false},
        {"bitsbee", "submitbudget", &submitbudget, true, true, false},
        {"bitsbee", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitsbee", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitsbee", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitsbee", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitsbee", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitsbee", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitsbee", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitsbee", "checkbudgets", &checkbudgets, true, true, false},
        {"bitsbee", "mnsync", &mnsync, true, true, false},
        {"bitsbee", "spork", &spork, true, true, false},
        {"bitsbee", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitsbee", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitsbeed, or the -server option to bitsbee-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitsbee-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:27028/\n";
}
