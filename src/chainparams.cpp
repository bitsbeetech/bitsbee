...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04a4c216f242a24fb56a861b8987e6a75513260aec0e7acaa11fd11c0dc012c28bc9e23857e08be20753d17a352b060e38eab5ace25213f92e189c55ebd200a96a");
        nDefaultPort = 27027;
       bnProofOfWorkLimit = ~uint256(0) >> 20;
        ...
        const char* pszTimestamp = "BitsBee , the SuperNode powered future of virtual money investment";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04b7418f8bdcb619ff0d02ef56bcc1c4ac9bbb70d031228c76a475b8c9bd482abd5e75d5b65e18e6850de141ed79a7f4672e12ada1cdf035cebe26b4f9cdbd24de") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1554433806;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 812388;

	    hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000007e78da8324fb9bde7ece9bb2647199be097d85a247bc83cd1157a9a9c87"));
        assert(genesis.hashMerkleRoot == uint256("0xba7cd46ec811c068e2c14d38dc2c246dda7979fb84fde328856e953d78413d8e"));
		
		vSeeds.push_back(CDNSSeedData("155.138.194.117", "155.138.194.117"));   // Primary DNS Seeder
		vSeeds.push_back(CDNSSeedData("96.30.195.219", "96.30.195.219"));  // Primary DNS Seeder
        ...
        strSporkKey = "04a4c216f242a24fb56a861b8987e6a75513260aec0e7acaa11fd11c0dc012c28bc9e23857e08be20753d17a352b060e38eab5ace25213f92e189c55ebd200a96a";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Bitsbee: 1 day
        nTargetSpacing = 1 * 60;  // Bitsbee: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("www.bitsbeetech.com", "www.bitsbeetech.com"));         // Single node address
        vSeeds.push_back(CDNSSeedData("www.bitsbeetech.com", "www.bitsbeetech.com"));       // Single node address
        vSeeds.push_back(CDNSSeedData("www.bitsbeetech.com", "www.bitsbeetech.com"));       // Single node address


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet bitsbee addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet bitsbee script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet bitsbee BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet bitsbee BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet bitsbee BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Bitsbee: 1 day
        nTargetSpacing = 1 * 60;        // Bitsbee: 1 minutes
