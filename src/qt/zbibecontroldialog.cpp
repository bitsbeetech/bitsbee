...
std::list<std::string> ZBibeControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZBibeControlDialog::listMints;
...
void ZBibeControlDialog::updateLabels()
{
    ...
    privacyDialog->setZBibeControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZBibeControlDialog::GetSelectedMints()
{
