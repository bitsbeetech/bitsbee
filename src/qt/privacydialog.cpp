...
void PrivacyDialog::sendzBIBE()
{
    ...
    if(ui->payTo->text().isEmpty()){
        ...
        if (!address.IsValid()) {
            QMessageBox::warning(this, tr("Spend Zerocoin"), tr("Invalid Bitsbee Address"), QMessageBox::Ok, QMessageBox::Ok);
            ui->payTo->setFocus();
            return;
        }
    }
    ...
    if (!ZBibeControlDialog::listSelectedMints.empty()) {
        vMintsSelected = ZBibeControlDialog::GetSelectedMints();
    }
    ...
    ZBibeControlDialog::listSelectedMints.clear();
