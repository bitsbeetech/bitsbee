                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bitsbee [BIBE]") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bitsbee address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitsbee: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bitsbee Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bitsbee Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bitsbee"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bitsbee addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bitsbee addresses"));
    ...
    openAction->setStatusTip(tr("Open a Bitsbee: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bitsbee Core help message to get a list with possible Bitsbee command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bitsbee Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitsbee network", "", count));
}
...
{
    QString strTitle = tr("Bitsbee [BIBE]"); // default title
