...
/** Utility functions used by the Bitsbee Qt UI.
 */
namespace GUIUtil
{
...
// Render Bitsbee addresses in monospace font
...
// Parse "bitsbee:" URI into recipient object, return true on successful parsing
