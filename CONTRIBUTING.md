Contributing to Bitsbee Core
============================

The Bitsbee Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bitsbee Core project, and is not to be
confused with overall Bitsbee Network Protocol consensus changes.

Whether a pull request is merged into Bitsbee Core rests with the project merge
...
Patches that change Bitsbee consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitsbee consensus, it must have been
...
The project leader is the release manager for each Bitsbee Core release.
